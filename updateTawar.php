...
<html>
<head>
	<title>Sistem Informasi Akademik::Daftar kultawar</title>
	<meta charset="utf-8">
...
if (isset($_POST['cari'])){
	$cari=$_POST['cari'];
	$sql="select * from kultawar where kultawar like'%$cari%' or
						  idkultawar like '%$cari%' or
						  npp like '%$cari%'";
}else{
...
if (isset($_POST['cari'])){
	...
	$sql="select * from kultawar where idkultawar like'%$cari%' or
						  idkultawarkultawar like '%$cari%' or
						  sks like '%$cari%'
